...
export const Footer = () => {
  return (
    ...
    <span> 
      ...
      <Grid item xs={3} className="hover:text-[#c8c8c8] cursor-pointer"> <div className="flex text-center justify-center"> </div> Terms of Service  </Grid>
      <Grid item xs={3} className="hover:text-[#c8c8c8] cursor-pointer"> Privacy Policy </Grid>
      <Grid item xs={3} className="hover:text-[#c8c8c8] cursor-pointer"> Oficial Realtors of Florida </Grid> 
      <Grid item xs={3} className="hover:text-[#c8c8c8] cursor-pointer"> DMCA Notice </Grid>  
      </Grid>
    </span>
    </div>
  );
